 ...
 * <p>
 * If an Async Island Leave event is cancelled, the Player will be teleported to the previous location.
 * <p>
 * This event is working only on PaperSpigot engine.
 */
public class AsyncIslandLeaveEvent extends Event implements Cancellable {
    ...
    public AsyncIslandLeaveEvent(UUID islandId, UUID playerId) {
        super(true);
