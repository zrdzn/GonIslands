 ...
 * <p>
 * If an Async Island Remove event is cancelled, the Island will not be removed.
 */
public class AsyncIslandRemoveEvent extends Event implements Cancellable {
    ...
    public AsyncIslandRemoveEvent(UUID islandId) {
        super(true);
